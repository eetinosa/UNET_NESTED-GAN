...
class myAugmentation(object):
    ...
    def __init__(
        self,
        train_path="dataset/train_aug/image",
        label_path="dataset/train_aug/label",
        merge_path="dataset/merge",
        aug_merge_path="dataset/aug_merge",
        aug_train_path="dataset/aug_train",
        aug_label_path="dataset/aug_label",
        img_type="png",
    ):
    ...
    def doAugmentate(
        self, img, save_to_dir, save_prefix, batch_size=1, save_format="png", imgnum=0
    ):
        """
    ...
    def splitMerge(self):
        ...
        for i in range(self.slices):
            ...
            for imgname in train_imgs:
                ...
                img_label = img[:, :, 0]
                cv2.imwrite(
                    path_train + "/" + midname + "." + "png", img_train
                )  # label
                cv2.imwrite(
                    path_label + "/" + midname + "_mask" + "." + "png", img_label
                )
