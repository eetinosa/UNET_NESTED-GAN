...
imgs_test, imgs_test_mask = pr.load_test_data()
# print(imgs_test)
# print('*' * 30)
# print(imgs_test_mask)
# print('*' * 30)
...
print('predicted_masks_flat',predicted_masks)

print('test_gt_masks_flat',imgs_test_gt)


# Area under the ROC curve
fpr, tpr, thresholds = roc_curve(
    test_gt_masks_flat, predicted_masks_flat, pos_label=255
)
...
plt.plot(
    recall, precision, "-", label="Area Under the Curve (AUC = %0.4f)" % AUC_prec_rec
)
